...
#### Aircraft True Heading (<span class="math inline">º</span>): THF {-#thf}
...
#### Attack Angle or Sideslip Angle (Fixed Vanes) (<span class="math inline">º</span>): AKFXx, SSFXx {-#akfxx}
...
```{r child='Boxes/boxStyles.Rmd'}
```

```{r child='Boxes/EDPCbox.Rmd'}
```
